...
| `MinigameBloomrush` | `Bloomrush (45)` | `BloomrushController` |
...
`Bloomrush(45)` is the **Manta-only bomb-tag party game** — the vessel's accessibility thesis
...
- **Fleet status** (audit it yourself: **FrogletTools > Vessels > Audit Vessel Ability Rows**, which
  ...
  |---|---|---|---|---|---|
  | Squirrel | complete | 4/4 | ✅ | ✅ | ✅ chip drawn |
