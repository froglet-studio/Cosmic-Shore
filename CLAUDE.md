...
| `MinigameScarabScramble` | `ScarabScramble (42)` | `ScarabScrambleController` |
...
`ScarabScramble(42)` is the **Scarab-only hoop-court party game** — the accessible sibling of
