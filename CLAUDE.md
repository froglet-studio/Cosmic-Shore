...
| `BENCHMARK_TOOL.md` | `_Scripts/Utility/PerformanceBenchmark/` | Performance Benchmark tool guide (tabs, score/hints, sweep, Load Time Insights, customization) plus the **DiagnosticsHUD console commands** (`fps uncap`, `diag <label> <s>`, `renderers`, `renderers hide/show`, `prismpath`, `prisms`) and troubleshooting |
