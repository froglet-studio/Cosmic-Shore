...
| **Falcon** | 9 | Planned |
| **Shrike** | 10 | Planned |
| **Sparrow** | 11 | Shooter — arcade space combat with guns and missiles. Missiles are stocked by DESTROYING HOSTILE PRISMS (not by crystals, since 2026-09), carry a proximity fuze that trips on opposing vessels and living fauna hearts, and throw a second blast that debuffs pilots and jousts creatures without touching mass (`R_VesselActions/SPARROW_SKYBURST_BAY.md`) |
...
IS the objective (0.02 per prism, 25 per rocket; `VesselRearmOnPrismDestruction`). The omni
