...
`Tools/Build/arcade_mode_lib.py`, the eleven registrations, the gates) and **the `/vessel` skill for ANY vessel-class work** — new vessels, abilities/executors,
