...
| `MinigameDrumfire` | `Drumfire (45)` | `DrumfireController` |
...
`Drumfire(45)` is the **Dolphin-only rhythm range** — the platform's first mode built to TEACH a
