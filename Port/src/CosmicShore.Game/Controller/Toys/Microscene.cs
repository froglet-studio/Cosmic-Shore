...
namespace CosmicShore.Gameplay
{
    ...
    public class Microscene : MonoBehaviour
    {
        ...
        /// </summary>
        public async Task PopulateAsync(MicroscenePlan plan, System.Random rng, CancellationToken ct)
        {
            Busy = true;
            try
            {
        ...
        /// and kind vary.
        /// </summary>
        public async Task RecycleAsync(MicroscenePlan plan, Pose pose, System.Random rng,
        ...
        {
            // PORT Deviation (drift 2026-07-07, FadeIn — restore when render/effects arc ports):
        ...
        async Task AnimateScaleAsync(float from, float to, float seconds, CancellationToken ct)
        {
            float elapsed = 0f;
