// Ported verbatim from _Scripts/Controller/Toys/PaintingToy.cs (painting-toy drift-sync
// 2026-07-09). Mechanical substitutions (README): UnityEngine → CosmicShore.Engine;
// TMPro → CosmicShore.Engine.UI; Cysharp.Threading.Tasks → CosmicShore.Engine.Tasks (only the
// .Forget() extension is used). OnInitialized/Update are `protected override` (base Toy grew
// them virtual). Replaces the old ShapeDefinition/MenuShapePainter implementation.
