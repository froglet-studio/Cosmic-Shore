// Ported verbatim from _Scripts/Controller/Toys/PaintingPrismStore.cs (painting-toy drift-sync 2026-07-09). Mechanical substitutions per README.
// Substitution: using UnityEngine; → using CosmicShore.Engine;. NOTE: relies on CosmicShore.Utility.DataAccessor (persistence helper — not yet present in the port).
using System;
