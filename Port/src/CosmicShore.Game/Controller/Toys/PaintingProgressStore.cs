// Ported verbatim from _Scripts/Controller/Toys/PaintingProgressStore.cs (painting-toy drift-sync 2026-07-09). Mechanical substitutions per README.
// No UnityEngine dependency — usings unchanged. NOTE: relies on CosmicShore.Utility.DataAccessor (persistence helper — not yet present in the port).
using System;
