// Ported verbatim from Assets/_Scripts/Controller/Vessel/DomainColorPaletteSO.cs
// (Tournament arc dependency — the Maelstrom scene view tints domain text/cards from it).
