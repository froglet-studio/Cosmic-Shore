...
namespace CosmicShore.Gameplay
{
    public class R_VesselActionHandler : NetworkBehaviour
    {
        ...
        void OnDisable()
        {
            ...
            if (_subscribedToInputPaused && vesselStatus?.Player is CosmicShore.Engine.Object obj && obj != null)
            {
        ...
        private async Task EndMuteWhenElapsedAsync(InputEvents ie, CancellationToken ct)
        {
    ...
    // PORT note: InputEventShipActionMapping and ResourceEventShipActionMapping were declared
    // at the bottom of this file in the Unity source. They were extracted verbatim to
    // Controller/Vessel/R_VesselActionMappings.cs at V9 (ShipHelper needed them before this
    // class ported) — they live there now, not here.
}
