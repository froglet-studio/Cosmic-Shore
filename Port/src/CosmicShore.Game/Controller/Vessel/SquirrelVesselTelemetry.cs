// Ported verbatim from Assets/_Scripts/Controller/Vessel/SquirrelVesselTelemetry.cs (stats-reporter family 2026-07-10).
...
namespace CosmicShore.Gameplay
{
    ...
    public class SquirrelVesselTelemetry : VesselTelemetry
    {
        ...
        protected override void OnTurnStartedExtended()
        {
            ...
            // PORT Deviation (impact-effects arc — restore when SkimmerStealPrismEffectSO ports):
