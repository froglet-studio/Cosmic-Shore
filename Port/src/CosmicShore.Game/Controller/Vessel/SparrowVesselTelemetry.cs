// Ported verbatim from Assets/_Scripts/Controller/Vessel/SparrowVesselTelemetry.cs (stats-reporter family 2026-07-10).
...
namespace CosmicShore.Gameplay
{
    ...
    public class SparrowVesselTelemetry : VesselTelemetry
    {
        ...
        {
            // PORT Deviation (vessel-actions arc — restore when the executor family ports):
