// Ported verbatim from Assets/_Scripts/Controller/Vessel/VesselTelemetry.cs (stats-reporter family 2026-07-10).
...
namespace CosmicShore.Gameplay
{
    ...
    public abstract class VesselTelemetry : MonoBehaviour
    {
        ...
        private void TrySubscribe()
        {
            ...
            // PORT Deviation (impact-effects arc — restore when VesselDamagePrismEffectSO ports):
