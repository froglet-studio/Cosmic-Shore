// Ported verbatim from Assets/_Scripts/Controller/Arcade/Tournament/TournamentStateMachine.cs
// (Tournament arc). Pure C# — no substitutions.
using System;
...
namespace CosmicShore.Gameplay
{
    ...
    /// Owned by <see cref="TournamentController"/>; invalid transitions are ignored (logged
    ...
    public class TournamentStateMachine
    {
        ...
        public event Action<TournamentPhase> OnPhaseChanged;
        ...
        /// </summary>
        public bool TransitionTo(TournamentPhase next)
        {
        ...
        /// <summary>Force back to <see cref="TournamentPhase.Idle"/> (exit / abort).</summary>
        public void ResetToIdle()
        {
            if (Current == TournamentPhase.Idle) return;
            Current = TournamentPhase.Idle;
            OnPhaseChanged?.Invoke(TournamentPhase.Idle);
        }
    }
}
