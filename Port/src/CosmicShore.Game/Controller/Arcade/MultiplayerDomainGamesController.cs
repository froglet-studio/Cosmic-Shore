// Ported verbatim from Assets/_Scripts/Controller/Arcade/MultiplayerDomainGamesController.cs
// (controller-chain arc). Mechanical substitutions only (README table); RPCs are
// local-invoke until the transport phase. The engine's NetworkManager gained
// ConnectedClientsIds for the ready-count (see NetworkManager.cs).
