// Ported from Assets/ArcadeDPadNav.cs (Arc F 2b) — verbatim; UnityEngine →
// CosmicShore.Engine, UnityEngine.InputSystem → CosmicShore.Engine.InputSystem,
// UnityEngine.UI → CosmicShore.Engine.UI. (Upstream file lives at the Assets root —
// placed with the arcade controllers here, namespace unchanged.)
