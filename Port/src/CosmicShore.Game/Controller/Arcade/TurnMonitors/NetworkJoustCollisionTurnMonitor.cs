...
// Ported verbatim from Assets/_Scripts/Controller/Arcade/TurnMonitors/NetworkJoustCollisionTurnMonitor.cs
// (Joust arc). Mechanical substitutions only (README table); RPCs are local-invoke
// until the transport phase.
...
namespace CosmicShore.Gameplay
{
    ...
    /// and ends the turn when any player reaches <see cref="JoustCollisionTurnMonitor.CollisionsNeeded"/>.
    /// </summary>
