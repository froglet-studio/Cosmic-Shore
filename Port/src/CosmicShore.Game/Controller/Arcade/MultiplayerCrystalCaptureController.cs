// Ported verbatim from Assets/_Scripts/Controller/Arcade/MultiplayerCrystalCaptureController.cs
// (Crystal Capture arc). Mechanical substitutions only (README table); RPCs are
// local-invoke until the transport phase.
