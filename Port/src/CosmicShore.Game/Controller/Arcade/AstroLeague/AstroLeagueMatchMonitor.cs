// Ported verbatim from Assets/_Scripts/Controller/Arcade/AstroLeague/AstroLeagueMatchMonitor.cs
// (AstroLeague arc). Mechanical substitutions only (README table); the display ClientRpc
// carries local-invoke semantics until the transport phase.
using System;
