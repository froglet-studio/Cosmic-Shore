// Ported verbatim from Assets/_Scripts/Controller/Arcade/Scoring/CrystalCaptureScoringRuleSO.cs
// (Crystal Capture arc). Mechanical substitutions only (README table).
