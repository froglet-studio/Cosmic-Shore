// Ported verbatim in V13 as a required companion of PrismStateManager (its shield
// duration/delay semantics and the internal ExecuteTimerDeactivation contract live
// here). Original: Assets/_Scripts/Controller/Managers/PrismTimerManager.cs.
