// Verbatim port of Assets/_Scripts/Controller/Party/Services/InviteService.cs
// (party-system arc 2026-07-08). Substitutions: UnityEngine → CosmicShore.Engine.
// No deviations — pure C# payload tracker; Debug.Log and Time.unscaledTime are
// engine-native.
// ─────────────────────────────────────────────────────────────────────────────
// InviteService.cs
