// Verbatim port of Assets/_Scripts/Controller/Party/Services/PartyMemberService.cs
// (party-system arc 2026-07-08). Substitutions: Unity.Services.Multiplayer →
// CosmicShore.Engine.Networking, UnityEngine → CosmicShore.Engine. One marked deviation below.
// ─────────────────────────────────────────────────────────────────────────────
