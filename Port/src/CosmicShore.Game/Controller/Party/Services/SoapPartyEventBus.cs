// Verbatim port of Assets/_Scripts/Controller/Party/Services/SoapPartyEventBus.cs
// (party-system arc 2026-07-08). Substitutions only: UnityEngine → CosmicShore.Engine.
// ─────────────────────────────────────────────────────────────────────────────
