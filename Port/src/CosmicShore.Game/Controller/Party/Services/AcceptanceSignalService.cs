// Ported verbatim from Assets/_Scripts/Controller/Party/Services/AcceptanceSignalService.cs
...
namespace CosmicShore.Gameplay
{
    ...
    public sealed class AcceptanceSignalService
    {
        ...
        {
            float deadline   = CosmicShore.Engine.Time.unscaledTime + timeoutSeconds;
            int   pollCount  = 0;

            while (CosmicShore.Engine.Time.unscaledTime < deadline)
            {
