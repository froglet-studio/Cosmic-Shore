// Ported verbatim from Assets/_Scripts/Controller/Party/StateMachine/PartyState.cs
// (party-system arc 2026-07-08). No using directives upstream — zero substitutions.
// Numeric values are frozen wire format (freeze test lives in EnumFreezeTests).
// ─────────────────────────────────────────────────────────────────────────────
// PartyState.cs
