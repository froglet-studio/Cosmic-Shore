// Ported verbatim from Assets/_Scripts/Controller/Party/StateMachine/PartyStateMachine.cs
// (party-system arc 2026-07-08). Sole mechanical substitution (README):
// `using UnityEngine;` → `using CosmicShore.Engine;` (Debug facade). Pure C# otherwise.
// ─────────────────────────────────────────────────────────────────────────────
