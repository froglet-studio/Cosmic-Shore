// Ported verbatim from Assets/_Scripts/Controller/Party/Interfaces/IPartyStateQuery.cs
// (party-system arc 2026-07-08). No substitutions needed — pure C# contract.
// PartyState resolves in-namespace once Controller/Party/StateMachine/PartyState.cs ports (this arc).
// ─────────────────────────────────────────────────────────────────────────────
// IPartyStateQuery.cs
