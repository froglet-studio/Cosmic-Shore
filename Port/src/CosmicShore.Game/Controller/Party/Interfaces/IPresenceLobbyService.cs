// Ported verbatim from Assets/_Scripts/Controller/Party/Interfaces/IPresenceLobbyService.cs
...
namespace CosmicShore.Gameplay
{
    ...
    public interface IPresenceLobbyService
    {
        ...
        /// </param>
        Task JoinOrCreateAsync(int maxPlayers);
        ...
        Task ConvergeToCanonicalAsync(int maxPlayers);
    }
}
