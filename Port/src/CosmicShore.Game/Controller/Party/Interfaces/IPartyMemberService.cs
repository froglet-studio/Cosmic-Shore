// Ported verbatim from Assets/_Scripts/Controller/Party/Interfaces/IPartyMemberService.cs
// (party-system arc 2026-07-08). Mechanical substitutions only (README):
// Unity.Services.Multiplayer → CosmicShore.Engine.Networking (ISession / IReadOnlyPlayer placeholders).
// ─────────────────────────────────────────────────────────────────────────────
