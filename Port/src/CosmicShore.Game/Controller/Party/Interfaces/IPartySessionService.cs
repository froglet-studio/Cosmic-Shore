// Ported verbatim from Assets/_Scripts/Controller/Party/Interfaces/IPartySessionService.cs
...
// Unity.Services.Multiplayer → CosmicShore.Engine.Networking (ISession placeholder).
// ─────────────────────────────────────────────────────────────────────────────
