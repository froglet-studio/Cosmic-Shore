// Ported verbatim from Assets/_Scripts/Controller/Party/Interfaces/INetworkTransitionService.cs
// (party-system arc 2026-07-08). Mechanical substitutions only (README):
// Cysharp.Threading.Tasks → System.Threading.Tasks; UniTask<bool> → Task<bool>.
// ─────────────────────────────────────────────────────────────────────────────
...
namespace CosmicShore.Gameplay
{
    ...
    public interface INetworkTransitionService
    {
        ...
        /// </returns>
        Task<bool> ShutdownAsync(float timeoutSeconds, CancellationToken ct);
        ...
        /// </returns>
        Task<bool> WaitForClientConnectionAsync(float timeoutSeconds, CancellationToken ct);
        ...
        /// </returns>
        Task<bool> WaitForSceneSyncAsync(string sceneName, float timeoutSeconds, CancellationToken ct);
