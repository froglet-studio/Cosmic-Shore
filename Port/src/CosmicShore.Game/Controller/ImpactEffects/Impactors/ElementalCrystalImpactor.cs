...
namespace CosmicShore.Gameplay
{
    public class ElementalCrystalImpactor : CrystalImpactor
    {
        ...
        async Task MoveToVesselThenPlaySpaceCollect(SkimmerImpactor skimmerImpactor)
        {
        ...
        async Task PlaySpaceCollectAndDestroy()
        {
            ...
            // PORT Deviation (CT1, restore when Crystal.CrystalModels + SpaceCrystalAnimator
            // port — the blendshape collect animation is render-side; headless crystals take
            // the no-animator path and destroy as soon as they reach the vessel):
