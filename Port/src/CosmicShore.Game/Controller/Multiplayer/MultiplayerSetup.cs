// Ported verbatim from Assets/_Scripts/Controller/Multiplayer/MultiplayerSetup.cs
...
namespace CosmicShore.Gameplay
{
    public class MultiplayerSetup : MonoBehaviour
    {
        ...
        async Task OnAuthenticationSignedInAsync()
        {
            EnsureHostStarted();
        ...
        private async Task ExecuteMultiplayerSetup()
        {
