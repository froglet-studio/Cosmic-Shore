// Ported verbatim from Assets/_Scripts/Controller/Multiplayer/MenuServerPlayerVesselInitializer.cs
...
// `UniTask.Delay(ms)` → `GameTask.Delay(ms)` — the scaled int-milliseconds overload).
...
namespace CosmicShore.Gameplay
{
    ...
    public class MenuServerPlayerVesselInitializer : ServerPlayerVesselInitializer
    {
        ...
        /// </summary>
        protected override async Task OnPlayerReadyToSpawnAsync(Player player, CancellationToken ct)
        {
            ...
            CancellationToken ct)
        {
            ...
            await GameTask.Delay(postSpawnDelayMs, cancellationToken: ct);
