// Ported from Assets/_Scripts/Controller/Multiplayer/ArcadeConfigSyncManager.cs
// (Arc F 2b-iii) — verbatim; Unity.Netcode → CosmicShore.Engine.Networking,
// UnityEngine → CosmicShore.Engine, Reflex.Attributes → CosmicShore.Engine.Injection.
