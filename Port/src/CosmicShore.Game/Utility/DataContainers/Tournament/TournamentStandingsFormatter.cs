// Ported verbatim from Assets/_Scripts/Utility/DataContainers/Tournament/TournamentStandingsFormatter.cs
// (Tournament arc). Pure functions — no substitutions needed beyond none at all.
