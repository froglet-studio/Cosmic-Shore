// Ported from Assets/_Scripts/UI/Elements/IntensitySelectButton.cs (Arc F 2b-iii) —
// verbatim; Obvious.Soap → CosmicShore.Engine.Soap, TMPro / UnityEngine.UI →
// CosmicShore.Engine.UI, UnityEngine → CosmicShore.Engine.
