// Ported from Assets/_Scripts/UI/Elements/DomainInfoData.cs (Arc F 2b-iii) — verbatim;
// TMPro / UnityEngine.UI → CosmicShore.Engine.UI, UnityEngine → CosmicShore.Engine.
// The #if UNITY_EDITOR OnValidate block compiles out (symbol undefined in the port),
// exactly as in a player build.
