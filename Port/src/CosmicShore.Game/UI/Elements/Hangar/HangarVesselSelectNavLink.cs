// Ported from Assets/_Scripts/UI/Elements/Hangar/HangarVesselSelectNavLink.cs (Hangar unit
// 2026-07-10) — verbatim (class HangarShipSelectNavLink); UnityEngine → CosmicShore.Engine,
// UnityEngine.UI → CosmicShore.Engine.UI.
