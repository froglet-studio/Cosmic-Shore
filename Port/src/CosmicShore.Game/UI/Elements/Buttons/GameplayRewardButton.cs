// Ported from Assets/_Scripts/UI/Elements/Buttons/GameplayRewardButton.cs (Hangar unit
// 2026-07-10) — verbatim; UnityEngine → CosmicShore.Engine, UnityEngine.UI / TMPro →
// CosmicShore.Engine.UI (duplicate using dropped), Reflex.Attributes →
// CosmicShore.Engine.Injection.
