// Ported from Assets/_Scripts/UI/Elements/NavLink.cs (Hangar unit 2026-07-10) — verbatim;
// UnityEngine → CosmicShore.Engine, UnityEngine.UI / TMPro → CosmicShore.Engine.UI,
