// Ported from Assets/_Scripts/UI/InfiniteScroll.cs (Hangar unit 2026-07-10) — verbatim;
// UnityEngine → CosmicShore.Engine, UnityEngine.UI → CosmicShore.Engine.UI,
// UnityEngine.Serialization → CosmicShore.Engine ([FormerlySerializedAs] is in the
// engine attribute shim; duplicate using dropped).
