// Ported from Assets/_Scripts/UI/Screens/ArcadeScreen.cs (Arc F 2b-ii) — verbatim;
// UnityEngine → CosmicShore.Engine, UnityEngine.UI → CosmicShore.Engine.UI,
// Reflex.Attributes → CosmicShore.Engine.Injection ([FormerlySerializedAs] carried
// by the engine's attribute shim).
