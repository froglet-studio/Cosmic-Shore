// Ported from Assets/_Scripts/UI/Screens/StoreScreen.cs (Store unit 2026-07-10) —
// verbatim; UnityEngine → CosmicShore.Engine, TMPro / UnityEngine.UI →
// CosmicShore.Engine.UI (duplicate usings collapsed), UnityEngine.Assertions →
// CosmicShore.Engine.Assertions, Reflex.Attributes → CosmicShore.Engine.Injection.
...
using CosmicShore.Engine.Assertions;
