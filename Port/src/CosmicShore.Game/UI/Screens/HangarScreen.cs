// Ported from Assets/_Scripts/UI/Screens/HangarScreen.cs (Hangar unit 2026-07-10) —
// verbatim; UnityEngine → CosmicShore.Engine, UnityEngine.UI → CosmicShore.Engine.UI
// (inline TMPro.TMP_Text qualifiers → TMP_Text, which lives there).
