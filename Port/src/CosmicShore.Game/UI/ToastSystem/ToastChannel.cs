// Ported verbatim from Assets/_Scripts/UI/ToastSystem/ToastChannel.cs
// (UI-shell arc 2026-07-08). Mechanical substitutions (README):
// UnityEngine → CosmicShore.Engine. FULLY LIVE — SO event channel; the view layer
// (ToastService / ToastItemView) subscribes when it ports.
