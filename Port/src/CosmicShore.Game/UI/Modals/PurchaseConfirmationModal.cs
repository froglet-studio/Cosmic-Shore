// Ported from Assets/_Scripts/UI/Modals/PurchaseConfirmationModal.cs (Store unit
// 2026-07-10) — verbatim; UnityEngine → CosmicShore.Engine, TMPro / UnityEngine.UI →
// CosmicShore.Engine.UI (duplicate usings collapsed), Reflex.Attributes →
