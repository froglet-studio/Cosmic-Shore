// Ported from Assets/_Scripts/UI/Views/ArcadeLoadoutView.cs (Arc F 2b-ii) — verbatim;
// TMPro / UnityEngine.UI → CosmicShore.Engine.UI, UnityEngine → CosmicShore.Engine,
// Reflex.Attributes → CosmicShore.Engine.Injection. Fully live — launches through
// gameData.SyncFromArcadeGame + InvokeGameLaunch (the real SOAP launch path).
