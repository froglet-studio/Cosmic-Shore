// Ported verbatim from Assets/_Scripts/System/MainMenuController.cs (Menu_Main scene-controller
// arc). Mechanical substitutions only (README table). Fully live — the sub-state machine,
// transition table, menu game-data config, ApplyMenuVesselClassToHost, autopilot activation,
// and all SOAP handlers run verbatim; AnalyticsServiceFacade is the Deviation-#11-style shell.
using System;
