// Ported from Assets/_Scripts/System/Progression/GameModeProgressionService.cs
// (Progression unit 2026-07-10; supersedes the Arc F 2b-ii 49L everything-unlocked
// shell) — verbatim; UnityEngine → CosmicShore.Engine, Reflex.Attributes →
// CosmicShore.Engine.Injection. The quest-chain progression over Cloud Save is REAL:
// unlock state, quest evaluation (stat + intensity-tier lanes), the vessel-hangar
// feature gate, and the ProgressionRepo save paths all run the upstream logic.
using System;
