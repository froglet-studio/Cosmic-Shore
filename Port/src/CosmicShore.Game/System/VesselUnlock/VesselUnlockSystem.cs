// Ported from Assets/_Scripts/System/VesselUnlock/VesselUnlockSystem.cs (Hangar unit
// 2026-07-10) — verbatim; no Unity usings in the source (SO_Vessel is global-namespace),
// so no substitutions were needed.
using System;
