// Ported verbatim from _Scripts/System/CloudData/Repositories/CloudDataRepository.cs (CloudSave arc 2026-07-09).
// Mechanical substitution (README): UnityEngine → CosmicShore.Engine. The debounce loop's raw
// Task.Delay is upstream's own (plain C# class, not UniTask) — kept verbatim (real-time delay).
using System;
