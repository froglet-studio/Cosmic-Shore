// Ported from Assets/_Scripts/Data/Captain.cs (Store unit 2026-07-10) — verbatim;
// UnityEngine / UnityEngine.Serialization → CosmicShore.Engine ([FormerlySerializedAs]
// carried by the engine's attribute shim; duplicate usings collapsed).
