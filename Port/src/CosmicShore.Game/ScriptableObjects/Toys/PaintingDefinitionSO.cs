// Ported verbatim from _Scripts/ScriptableObjects/Toys/PaintingDefinitionSO.cs (painting-toy drift-sync 2026-07-09). Mechanical substitutions per README.
// Only substitution: using UnityEngine; → using CosmicShore.Engine;
using System;
