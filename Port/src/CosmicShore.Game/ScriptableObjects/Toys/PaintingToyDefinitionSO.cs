// Ported verbatim from _Scripts/ScriptableObjects/Toys/PaintingToyDefinitionSO.cs (painting-toy
// drift-sync 2026-07-09). Mechanical substitution (README): UnityEngine → CosmicShore.Engine.
// Replaces the old single-ShapeDefinition toy with the multi-painting gallery (fans a station per
// PaintingDefinitionSO around the ring; built-in default gallery when none authored).
