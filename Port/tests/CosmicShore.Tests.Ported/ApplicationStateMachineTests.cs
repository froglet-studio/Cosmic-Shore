// Ported verbatim from Assets/_Scripts/System/Bootstrap/Tests/ApplicationStateMachineTests.cs
// (bootstrap arc 2026-07-08). Mechanical substitutions (README): the `#if UNITY_EDITOR`
// guard is dropped (this suite IS the EditMode runner's port); Obvious.Soap →
...
namespace CosmicShore.Core
{
    ...
    public class ApplicationStateMachineTests
    {
        ...
        public void SetUp()
        {
            ...
            {
                var field = typeof(CosmicShore.Engine.Soap.ScriptableVariable<ApplicationStateData>)
