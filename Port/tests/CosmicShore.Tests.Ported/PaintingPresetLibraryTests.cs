// Ported verbatim from Assets/_Scripts/Tests/EditMode/PaintingPresetLibraryTests.cs
// (deferred-sweep 2026-07-10; the test file arrived with the painting-toy rework
// drift-sync of 2026-07-09). Mechanical substitutions (README): the `#if UNITY_EDITOR`
// guard is dropped (this suite IS the EditMode runner's port); UnityEngine →
// CosmicShore.Engine.
