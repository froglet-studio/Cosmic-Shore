// Ported verbatim from Assets/_Scripts/Tests/EditMode/TournamentDataSOTests.cs
// (Tournament arc). Mechanical substitutions (README): UnityEngine → CosmicShore.Engine,
// Obvious.Soap → CosmicShore.Engine.Soap; the `#if UNITY_EDITOR` guard is dropped
// (this suite always runs headless).
