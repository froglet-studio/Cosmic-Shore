...
OWNED_ELSEWHERE = {
    ...
    "Apollonia Flora ": "Tools/Build/author_mandelbulb_flora_assets.py",
    "Watershed Flora ": "Tools/Build/author_mandelbulb_flora_assets.py",
    "Coral Bloom Flora ": "Tools/Build/author_mandelbulb_flora_assets.py",
