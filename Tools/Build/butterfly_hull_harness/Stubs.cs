// UnityEngine math stubs for compiling ButterflyHullForm (copied from scarab_icon_harness,
// plus Mathf.Exp for the wing's tip-flare gaussian). Originally: stubs for compiling ScarabHullForm (the pure hull generator) outside Unity:
