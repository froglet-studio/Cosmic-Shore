...
| Submitted | yes — 2026-09-12 19:32 · 3 verdict(s), 3 new this run |
## Results
...
| QA-CRYSTAL-CHARGE-SHADER | PARTIAL | Step one looks fine. The crystals seem to not have any crackles. Crystals appear out of nowhere instead of blooming in. The crystals nearly blend in with the bright areas of the background. |
