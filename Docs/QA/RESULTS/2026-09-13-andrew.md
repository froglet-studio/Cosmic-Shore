...
| Submitted | yes — 2026-09-13 19:26 · 1 verdict(s), 1 new this run |
## Results
...
| ID | Result | Notes |
|---|---|---|
| QA-FTUE-QUEST-ROWS | BLOCKED | I can't find the Quest Graph Editor |
...
Files live in `Docs/QA/RESULTS/evidence/2026-09-13-andrew/` and are referenced from the Notes
