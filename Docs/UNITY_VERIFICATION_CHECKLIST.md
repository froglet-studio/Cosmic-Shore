...
3. ~~Do not Raise the two shape events~~ — moot since 2026-09: their prism-prefab listeners were stripped (`PERFORMANCE_OPTIMIZATION.md` §0.11.6), so nothing listens.
