...
| `Tool` | 8 toys — Vessel Changer, Domain Changer, Element Charger, Cell Selector, Wanderway, Arkway, Connect the Dots, Lifeform Matrix | the **choices it offers** (hulls, worlds, paintings, kingdoms, domains, elements) |
