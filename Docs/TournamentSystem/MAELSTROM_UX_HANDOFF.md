...
**Deferred / pre-existing (not this session)** — see `Docs/TournamentSystem/ARCHITECTURE.md §9` and
...
| `Docs/TournamentSystem/ARCHITECTURE.md` | §4 owner tag + readable dwell notes |
| `Docs/ShuffleSystem/ARCHITECTURE.md`, `CLAUDE.md` | rename references → Maelstrom |

**Canonical references:** `Docs/TournamentSystem/ARCHITECTURE.md` (mechanics, §4/§7/§9),
