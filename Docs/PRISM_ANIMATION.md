...
side) and the palette (the shield's current team colours, carried per-entity exactly as
death debris carries a dying prism's tier colours). `Prism.Damage`'s shield-shed branch
