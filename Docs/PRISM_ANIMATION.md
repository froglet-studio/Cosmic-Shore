...
| C10 | Worm segment make-room shift → stamped slide (locomotion stays mover-contract) | ✅ 2026-08-02: resolved by deletion — legacy `Worm.cs` removed in the worm-colony kaiju rebuild; `WormFauna` locomotion rides the mover contract (Docs/ECOSYSTEM.md §21) |
