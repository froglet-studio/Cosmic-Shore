...
|---|---|---|---|
| B1 | Presence | `LobbyPatcher` stale-index `ArgumentOutOfRangeException` spam at game start | <span class="badge investigating">[yellow] Mitigated</span> |
| B2 | Party | `ObjectDisposedException` (semaphore) on play-mode abort / fast accept | <span class="badge open">[red] Open</span> |
| B3 | Party | Bounce leaves two vessels + dead controls | <span class="badge open">[red] Open</span> |
| B3.b | Party | Same symptom on the clean-leave path | <span class="badge fixed">[green] Fixed</span> |
| B4 | Presence | Second invite not delivered + members vanish from 3rd player | <span class="badge open">[red] Open</span> |
| B5 | Party | Second joiner fails to join | <span class="badge open">[red] Open</span> |
| B6 | Presence | `WrappedLobbyService` NRE + empty online/request lists | <span class="badge investigating">[yellow] Mitigated</span> |
| B7 | Party | Client pair-init runs before remote identity replicates | <span class="badge deferred">[white] Deferred (benign)</span> |
| B8 | Party | Host phantom-rejoin loop from stale `joined_party` | <span class="badge fixed">[green] Fixed</span> |
