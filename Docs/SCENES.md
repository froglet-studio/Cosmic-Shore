...
| **MinigameCanopyRun** | `_Scenes/Multiplayer Scenes/` | `CanopyRun (45)` | `CanopyRunController` (Gibbon-only brachiation race — see `CANOPYRUN.md`) |
...
| 45 | `CanopyRun` | MP Racing | MinigameCanopyRun | `CanopyRunController` (Gibbon brachiation race on Skim Race's course — see `CANOPYRUN.md`) |
