...
| **MinigameBreakwater** | `_Scenes/Multiplayer Scenes/` | `Breakwater (48)` | `BreakwaterController` |
...
| 47 | `Drumfire` | MP | MinigameDrumfire | `DrumfireController` (Dolphin rhythm range — see `DRUMFIRE.md`) |
| 48 | `Breakwater` | MP | MinigameBreakwater | `BreakwaterController` (Sparrow station race — see `BREAKWATER.md`) |
