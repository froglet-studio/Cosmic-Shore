...
> 2. `Docs/ECOSYSTEM.md` -> Sec 0 (mass-conservation invariant), Sec 5 (locked decisions),
>    Sec 7 (the 3-species food web as it stands), Sec 10 (roadmap - your work extends
>    Phase 2).
...
>
> **Hold these invariants as non-negotiable (do not relitigate - see ECOSYSTEM.md Sec 0
> and CLAUDE.md):**
...
- **Tadpole** (`Boid`, `forager=true`, herbivore): emergent forager. Seeks the
  ...
  `Consume`s any unshielded non-fauna prism (suction + health-prism body), 10x
...
**Two test scenes wired** (`Docs/ECOSYSTEM.md` Sec 7.2):
...
4. **Fauna reproduction -> retire the fixed-period spawner cheat. [x] LANDED.**
...
6. **Domain territory dynamics + flora succession + cross-cell migration.**
   (ECOSYSTEM.md Sec 10 steps 5-7.) As fauna cull and flora regrow, controlling domain
...
| `Docs/ECOSYSTEM.md` | Sec 0 mass-conservation invariant, Sec 5 locked decisions, Sec 7 food web, Sec 9 key files, Sec 10 roadmap |
