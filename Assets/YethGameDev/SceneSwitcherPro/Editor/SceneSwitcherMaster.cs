...
namespace YethGameDev.SceneSwitcherMaster
{
    public class SceneSwitcherMaster : EditorWindow
    {
        ...
        private const string k_FavoritesKey = "SceneSwitcher.Master.Favorites";
        private const string k_Version = "1.0.0";

        [MenuItem("Window/Scene Switcher %&m")]
        private static void OpenWindow() => GetWindow<SceneSwitcherMaster>("Scene Switcher Master");
