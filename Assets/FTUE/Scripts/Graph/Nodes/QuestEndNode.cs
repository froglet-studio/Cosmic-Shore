...
namespace CosmicShore.Core
{
    ...
    /// completion (UGS + local mirror) and stops. Place exactly one at the end of the
    /// final phase.
    /// </summary>
    public class QuestEndNode : QuestNodeSO
    {
        public override QuestNodeCategory Category => QuestNodeCategory.Terminal;
        public override string TypeTooltip => "Completes the WHOLE quest: persists completion to UGS and stops the runner. Use Phase End to advance between phases.";
