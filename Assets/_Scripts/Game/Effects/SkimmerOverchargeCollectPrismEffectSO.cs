...
namespace CosmicShore.Game
{
    ...
    public class SkimmerOverchargeCollectPrismEffectSO:ImpactEffectSO<R_SkimmerImpactor, R_PrismImpactor>
    {
        ...
        private static readonly Dictionary <R_SkimmerImpactor,HashSet<R_PrismImpactor>> hitsBySkimmer = new();
        private static readonly Dictionary <R_SkimmerImpactor,float> cooldownTimers = new();
