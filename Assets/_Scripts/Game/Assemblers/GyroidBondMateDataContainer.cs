...
namespace CosmicShore
{
    ...
    {
        public static Dictionary<(GyroidBlockType, CornerSiteType), GyroidBondMateData> BondMateDataMap =
            InitializeBondMateData();
            ...
            return new Dictionary<(GyroidBlockType, CornerSiteType), GyroidBondMateData>
            {
                // Example initialization, replace with actual data
                {
                    (GyroidBlockType.AB, CornerSiteType.TopLeft), new GyroidBondMateData
                    {
                        ...
                        DeltaForward = new Vector3(-0.0017704640275681045f, -0.0008529851738756212f,
                            -1.931065308468478e-06f),
                ...
                },
                {
                    (GyroidBlockType.AB, CornerSiteType.BottomLeft), new GyroidBondMateData
                    {
                        ...
                        DeltaPosition =
                            new Vector3(-1.3501540319990641f, -2.3385356118535574f, -0.0013283825792559378f),
                        DeltaUp = new Vector3(0.8660249881031888f, -0.5000002452305752f, 0.0010222261940469601f),
                        DeltaForward = new Vector3(-0.0016234486769176504f, 0.0011077786560099445f,
                            -1.931381275731953e-06f),
                        BlockType = GyroidBlockType.BA,
                        isTail = false
                    }
                },
                ...
                },
                {
                    (GyroidBlockType.BA, CornerSiteType.TopLeft), new GyroidBondMateData
                    {
                        ...
                        DeltaForward = new Vector3(0.0017705979656557264f, 0.0008531383525940074f,
                            -1.931433121594951e-06f),
                        BlockType = GyroidBlockType.AB,
                        isTail = true
                    }
                },
                ...
                },
                {
                    (GyroidBlockType.BA, CornerSiteType.BottomLeft), new GyroidBondMateData
                    {
                        ...
                        DeltaForward = new Vector3(0.001623938995529322f, -0.0011067743051439579f,
                            -1.9310653085597676e-06f),
                        BlockType = GyroidBlockType.AB,
                        isTail = false
                    }
                },
                ...
                },
                {
                    (GyroidBlockType.GEs, CornerSiteType.TopRight), new GyroidBondMateData
                    {
                        ...
                        DeltaForward = new Vector3(-0.056848705142062694f, -0.19528325002505495f,
                            -0.020930079687909234f),
                        BlockType = GyroidBlockType.EsC,
                        isTail = true
                    }
                },
