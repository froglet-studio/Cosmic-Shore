...
namespace CosmicShore.Core
{
    ...
    public class R_Ship : MonoBehaviour, IShip, IShipHUDController
    {
                ...
                switch (effect)
                {
                    case CrystalImpactEffects.AreaOfEffectExplosion:
                        ...
                        aoeExplosion.MaxScale = ShipStatus.ResourceSystem.Resources.Count > ammoResourceIndex
                            ? Mathf.Lerp(minExplosionScale, maxExplosionScale, ShipStatus.ResourceSystem.Resources[ammoResourceIndex].CurrentAmount)
                            : maxExplosionScale;
                        aoeExplosion.Detonate(this);
                        break;
                    case CrystalImpactEffects.IncrementLevel:
                        ShipStatus.ResourceSystem.IncrementLevel(crystalProperties.Element);
                        break;
                ...
                switch (effect)
                {
                    ...
                    case TrailBlockImpactEffects.Bounce:
                        ...
                        ShipStatus.ShipTransformer.ModifyVelocity(
                            (transform.position - trailBlockProperties.trailBlock.transform.position).normalized * 5,
                            Time.deltaTime * 15);
                        break;
                    ...
                    case TrailBlockImpactEffects.Explode:
                        trailBlockProperties.trailBlock.Damage(ShipStatus.Course * ShipStatus.Speed * Inertia,
        ...
        public void PerformShipControllerActions(InputEvents controlType)
        {
            ...
            {
                actionHandler.Perform(controlType);
                return;
            }
        ...
        public void StopShipControllerActions(InputEvents controlType)
        {
            ...
            if (actionHandler != null)
            {
                actionHandler.Stop(controlType);
                return;
            }
