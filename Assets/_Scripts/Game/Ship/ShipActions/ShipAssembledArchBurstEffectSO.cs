...
{
    [CreateAssetMenu(fileName = "AssembledArchBurstEffectSO", menuName = "ScriptableObjects/Impact Effects/AssembledArchBurstEffectSO")]
    public class ShipAssembledArchBurstEffectSO : ImpactEffectSO<R_ShipImpactor, R_ShipImpactor>
    {
        ...
        protected override void ExecuteTyped(R_ShipImpactor impactor, R_ShipImpactor impactee)
        {
        ...
        void SpawnRod(Vector3 a, Vector3 b, Vector3 up, Transform parent)
        {
            ...
            var go = Object.Instantiate(rodPrefab, mid, Quaternion.LookRotation(dir, up), parent);
