...
{
    [CreateAssetMenu(fileName = "OtherHapticsToShipEffectWrapper",
        menuName = "ScriptableObjects/Impact Effects/Other/OtherHapticsToShipEffectWrapperSO")]
    public class OtherHapticsToShipEffectWrapperSO : ImpactEffectSO<ImpactorBase, ShipImpactor>
    {
        [SerializeField] ShipHapticsByOtherEffectSO shipHapticsByOtherEffect;
