...
{
    [CreateAssetMenu(fileName = "OtherPrismSpawnCooldownToShipEffectWrapper",
        menuName = "ScriptableObjects/Impact Effects/Other/OtherPrismSpawnCooldownToShipEffectWrapperSO")]
