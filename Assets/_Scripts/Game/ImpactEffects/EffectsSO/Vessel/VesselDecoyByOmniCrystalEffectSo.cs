...
{
    [CreateAssetMenu(fileName = "ShipDecoyByOmniCrystalEffect", menuName = "ScriptableObjects/Impact Effects/Vessel/VesselDecoyByOmniCrystalEffectSo")]
    public class VesselDecoyByOmniCrystalEffectSo : VesselCrystalEffectSO
    {
