...
namespace CosmicShore.Gameplay
{
    ...
    public class AOECylindricalExplosion : AOEExplosion
    {
        ...
        /// radius, which for a swept plate is not a radius at all — it is the plate's DIAMETER, with its
        /// length derived from a separate dial — so an inherited answer would draw a sphere of the
        /// wrong size around the wrong thing.
        ///
