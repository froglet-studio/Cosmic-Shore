...
namespace CosmicShore.Gameplay
{
    ...
    public class MenuCrystalClickHandler : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("How long the camera blend takes. " +
        ...
        async UniTaskVoid TransitionToFreestyle()
        {
            ...
            // Raise SOAP event early so camera blend starts immediately.
            // UI fade and camera blend then run in parallel.
        ...
        async UniTaskVoid TransitionToMenu()
        {
            ...
            // Raise SOAP event early so camera blend starts immediately.
            // Camera blend runs in parallel with the UI fade.
