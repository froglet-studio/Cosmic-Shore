...
{
    /// <summary>
    /// Objective provider for any GATE RACE: the local pilot's NEXT gate.
    ///
    /// <para>This is the mode's whole answer to "which of these identical rings is mine",
    ...
    /// </summary>
    public class RaceGateObjectiveProvider : MonoBehaviour, IObjectiveProvider
    {
        [Inject] GameDataSO gameData;

        GateRaceController _controller;
        ...
        public bool TryGetObjective(out Transform target)
        {
            ...
            if (_controller == null)
                _controller = FindAnyObjectByType<GateRaceController>();
