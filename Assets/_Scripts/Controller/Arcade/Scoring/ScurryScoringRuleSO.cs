...
{
    /// <summary>
    /// Crystal Capture: golf-timed like SkimRace. Shares <c>NetworkCrystalCollisionTurnMonitor</c>
    /// with SkimRace, so the turn ends when an active domain's summed crystals reach the target;
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "ScriptableObjects/Scoring Rules/Scurry", fileName = "ScurryScoringRule")]
    public class ScurryScoringRuleSO : ScoringRuleSO
    {
