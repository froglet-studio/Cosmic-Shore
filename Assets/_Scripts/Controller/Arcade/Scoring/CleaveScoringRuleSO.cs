...
{
    /// <summary>
    /// Cleave: the race is DESTRUCTION. The turn ends (<c>CleavePrismTurnMonitor</c>) when an
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "ScriptableObjects/Scoring Rules/Cleave", fileName = "CleaveScoringRule")]
    public class CleaveScoringRuleSO : ScoringRuleSO
    {
