...
{
    /// <summary>
    /// Ribcage: the race is DESTRUCTION. The turn ends (<c>RibcagePrismTurnMonitor</c>) when an
    ...
    /// sentinel encoding their team's remaining prisms. Golf-timed like HexRace/Scurry/Rampage.
    ///
