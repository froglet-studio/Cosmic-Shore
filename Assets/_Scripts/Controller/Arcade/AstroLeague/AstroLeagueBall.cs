...
namespace CosmicShore.Gameplay
{
    ...
    public class AstroLeagueBall : NetworkBehaviour
    {
        ...
        ///     ball, which has no color yet)           mass (speed x= M/(M + k*volume), direction kept).
        ...
        /// <summary>The ball's world-space radius (collider radius x max lossy scale) - tracks intensity scaling.</summary>
        ...
        /// vessel imparts up to ~2x its speed (the kick) and the ball cleanly bounces off - a stationary
