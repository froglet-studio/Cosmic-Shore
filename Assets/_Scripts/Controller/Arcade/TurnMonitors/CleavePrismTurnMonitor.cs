...
{
    /// <summary>
    /// Turn monitor for Cleave. The cage TARGET - how many prisms a domain must destroy to
    ...
    /// condition: <c>CleaveController</c> reads the SAME number to place the 25% / 50% release
    ...
    /// </summary>
    public class CleavePrismTurnMonitor : TurnMonitor
    {
