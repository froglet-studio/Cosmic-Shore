...
{
    /// <summary>
    /// Turn monitor for Ribcage. The cage TARGET - how many prisms a domain must destroy to
    ...
    /// condition: <c>RibcageController</c> reads the SAME number to place the 25% / 50% release
    ...
    /// </summary>
    public class RibcagePrismTurnMonitor : TurnMonitor
    {
