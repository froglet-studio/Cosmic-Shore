...
namespace CosmicShore.Gameplay
{
    ...
    ///      <c>CombatHitScoring.Credit</c>), so like Rampage and Cleave there is no per-event
    ...
    ///   2. THE ARENA IS COVER, NOT THE OBJECTIVE. Cleave's bone IS the score and Wildlife
