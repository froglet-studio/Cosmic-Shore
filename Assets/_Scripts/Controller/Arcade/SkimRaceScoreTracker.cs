...
{
    /// <summary>
    /// Handles scoring logic for SkimRace (single and multiplayer).
    ...
    /// </summary>
    public class SkimRaceScoreTracker : BaseScoreTracker, IStatExposable
    {
        [Header("Dependencies")]
        ...
        void HandleTurnStarted()
        {
            ...
            if (_vesselTelemetry == null)
                CSDebug.LogWarning("[SkimRaceScoreTracker] No VesselTelemetry found on local vessel.");
        ...
        void HandleGameEnd()
        {
            ...
            float finalScore = isWinner ? _elapsedRaceTime : GolfScoreSentinels.EncodeSkimRaceLoserScore(crystalsRemaining);
