...
| Class | Role |
|---|---|
| `AstroLeagueController` | Match director (server-authoritative): kickoffs, goal attribution, celebrations, golden-goal overtime, winner banner, AI striker arming, final-score sync (SkimRace/Joust/CC `SyncFinalResults_ClientRpc`, the shared `MultiplayerDomainGamesController` tail) |
