...
| **Time** | Charge Fill Rate (drift) | boost fill `×1.5` at level 10 | **Drift Ward** — no DANGER-PRISM elemental debuff while drifting (an opposing pilot's blast still lands) |
