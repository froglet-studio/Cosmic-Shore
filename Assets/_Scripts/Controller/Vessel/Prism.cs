    ...
    public class Prism : MonoBehaviour
    {
        ...
        public void Restore()
        {
            if (!devastated)
            {
                ...
                // (zen-volta's NotifyPrismActivated hook is intentionally absent here:
                // our LOD manager still sweeps periodically and classifies this
                // collider on its next tick.)
                RefreshVolumeCache();
            }
        }
