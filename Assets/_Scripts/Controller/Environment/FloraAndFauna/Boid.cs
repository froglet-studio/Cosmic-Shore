...
namespace CosmicShore.Gameplay
{
    ...
    public class Boid : Fauna
    {
        ...
        private (Prism, GyroidAssembler) NewBlock()
        {
            ...
            // Pooled prisms may already carry a GyroidAssembler from a previous use
            if (!newBlock.gameObject.TryGetComponent<GyroidAssembler>(out var gyroidBlock))
                gyroidBlock = newBlock.gameObject.AddComponent<GyroidAssembler>();
