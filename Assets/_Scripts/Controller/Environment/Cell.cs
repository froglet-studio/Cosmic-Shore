...
namespace CosmicShore.Gameplay
{
    public class Cell : MonoBehaviour
    {
        ...
        /// its baked animation are untouched. See Docs/ECOSYSTEM.md Sec 7.2.
        /// </summary>
        ...
        // per-domain bookkeeping (the Sec 2.3.1 phantom-count class of bug).
        ...
        /// (Docs/ECOSYSTEM.md Sec 5). HUDs read this for the spawn-cycle ring. Returns 0 when
        ...
        /// See Docs/ECOSYSTEM.md Sec 0/Sec 5.
        /// </summary>
        ...
        /// population bound (Docs/ECOSYSTEM.md Sec 6).
        /// </summary>
        ...
        CellPhaseThresholds ResolveThresholds()
        {
            ...
            // the spine derive their volume ladder from the count fields (x16).
        ...
        //  to it - acceptable, those legacy populations never instantiate (Sec 7).
        //  See Docs/ECOSYSTEM.md Sec 6/Sec 7.
        // ---------------------------------------------------------------------
        ...
        public bool ContainsPosition(Vector3 position)
        {
            ...
            // across the full Skim Race track. See SenseRadius / Docs/ECOSYSTEM.md Sec 7.2.
