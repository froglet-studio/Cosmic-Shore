...
namespace CosmicShore.Gameplay
{
    public sealed class RandomLifeSpawner : CellLifeSpawnerBase
    {
            ...
            FaunaConfigurationSO faunaCfg)
        {
            ...
            // (Docs/ECOSYSTEM.md Sec 6: prey-linked production + starvation + reproduction.)
            ...
            // authored in nominal prisms, converted xNominalPrismVolume for the
            // herbivore volume check, and read directly as N herbivores for a
            // predator. (Docs/ECOSYSTEM.md Sec 6-Sec 7.)
