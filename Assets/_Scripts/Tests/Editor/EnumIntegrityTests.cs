...
namespace CosmicShore.Tests
{
    ...
    public class EnumIntegrityTests
    {
        ...
        {
            // 45 = IDs 0..46 with 7 and 31 deliberately skipped (retired Freestyle / never
            // assigned), and 47 now retired too (Drumfire, removed 2026-09) — see GameModes.cs.
            // Deliberately a hard-coded number rather than one derived from the enum: the whole
            // point is that ADDING a mode fails here, so a human confirms the addition was
            // intended and that its ID reuses none of 7, 31 or 47.
            // It has drifted six times now (33 -> 42 -> 43 -> 44 -> 45 -> 46 -> 45), so
            ...
            Assert.AreEqual(45, values.Length,
