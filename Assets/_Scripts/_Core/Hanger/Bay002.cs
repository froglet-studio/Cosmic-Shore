...
public class Bay002 : MonoBehaviour, IDataPersistence
{
    ...
    {
        this.pilot = data.Bay002Pilot;
        this.ship = data.Bay002Ship;
    }

    public void SaveData(ref HangerData data)
    {
        data.Bay002Pilot = this.pilot;
        data.Bay002Ship = this.ship;
    }
    #region Ignore me
