...
{
    /// <summary>
    /// Single home for turning <see cref="MaelstromDataSO"/> standings into display strings, so the
    /// between-game loading splash (<c>BootStatusBroadcaster</c>) and the end-of-shuffle results screen
    /// (<c>MaelstromSceneView</c>) format identically and can't drift apart (DRY). Pure functions - no
    ...
    /// row) to tag nothing.
    /// </summary>
    public static class MaelstromStandingsFormatter
    {
        /// <summary>
        ...
        /// "(You)".
        /// </summary>
        public static string FormatRunning(MaelstromDataSO data, Domains localDomain = Domains.Blue)
        {
        ...
        /// </summary>
        public static string FormatConnecting(MaelstromDataSO data, Domains localDomain = Domains.Blue)
        {
            if (data == null) return string.Empty;
        ...
        /// </summary>
        public static string FormatFinal(MaelstromDataSO data, Domains localDomain = Domains.Blue)
        {
            if (data == null) return string.Empty;
