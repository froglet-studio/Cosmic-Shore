...
namespace CosmicShore.Utility
{
    ...
    /// and awards <see cref="MaelstromDataSO.PointsByPlace"/> by place.
    /// </summary>
    [System.Serializable]
    public class MaelstromDomainStanding
    {
    ...
    /// into <see cref="MaelstromDataSO.History"/>. Needed because the Maelstrom hub / summary is a
    ...
    /// </summary>
    [System.Serializable]
    public class MaelstromPlayerSnapshot
    {
        public string Name;
        public Domains Domain;
    ...
    /// </summary>
    [System.Serializable]
    public class MaelstromRoundRecord
    {
        ...
        public List<MaelstromPlayerSnapshot> Players = new();
    ...
    /// </summary>
    [System.Serializable]
    public class MaelstromIntensityTier
    {
    ...
    public class MaelstromDataSO : ScriptableObject
    {
        ...
        public List<MaelstromIntensityTier> IntensityTiers = new();
        ...
        [Tooltip("This meta-mode's OWN Arcade card (ArcadeGameMaelstrom.asset). Its DisplayName is the " +
                 "player-facing name of the mode (currently \"Maelstrom\") and is the SINGLE SOURCE of that " +
                 "name: the Arcade grid card AND the in-scene title (MaelstromSceneView) both read it. To " +
        ...
        [Tooltip("Minimum seconds the between-game loading splash holds the running standings before the " +
                 ...
                 "are never delayed. See MaelstromController.MinLoadSplashDwellSeconds.")]
        public float BetweenGameSummaryDwellSeconds = 2f;

        [Header("SOAP Events")]
        public ScriptableEventNoParam OnMaelstromStarted;
        public ScriptableEventNoParam OnGameResultRecorded;
        public ScriptableEventNoParam OnStandingsChanged;
        public ScriptableEventNoParam OnMaelstromCompleted;
        ...
        /// </summary>
        [System.NonSerialized] public List<MaelstromRoundRecord> History = new();
        ...
        /// "Maelstrom" if <see cref="ModeCard"/> is unwired. Single source for titles/headers, used by
        /// the scene view and <see cref="MaelstromStandingsFormatter"/>.
        /// </summary>
        public string ModeName =>
            ModeCard != null && !string.IsNullOrEmpty(ModeCard.DisplayName) ? ModeCard.DisplayName : "Maelstrom";
        ...
        /// <c>MaelstromController.StartMaelstromInternal</c>), falling back to the serialized
        ...
        /// <summary>
        /// Stamp the runtime win target, resolved by <c>MaelstromController</c> from the End Game
        ...
        /// caller supplies it - <c>MaelstromController</c> passes the mode's authoritative
        ...
        public void RecordResults(IReadOnlyList<ScoreResult> results,
                                  List<MaelstromPlayerSnapshot> playerSnapshots = null,
                                  ...
                                  IReadOnlyList<Domains> domainPlacementOrder = null)
        {
            ...
            History.Add(new MaelstromRoundRecord
            {
        ...
        /// </summary>
        static List<MaelstromPlayerSnapshot> BuildSnapshotsFromResults(IReadOnlyList<ScoreResult> results)
        {
            var list = new List<MaelstromPlayerSnapshot>(results.Count);
        ...
        /// </summary>
        public List<MaelstromDomainStanding> BuildSortedStandings()
        {
            var sorted = new List<MaelstromDomainStanding>(Standings);
            sorted.Sort((a, b) =>
            {
        ...
        MaelstromDomainStanding FindOrCreate(Domains domain)
        {
            for (int i = 0; i < Standings.Count; i++)
                if (Standings[i].Domain == domain)
                    return Standings[i];

            var created = new MaelstromDomainStanding { Domain = domain };
