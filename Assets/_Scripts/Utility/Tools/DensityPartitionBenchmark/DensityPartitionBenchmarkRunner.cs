...
namespace CosmicShore.Utility.Tools.DensityPartitionBenchmark
{
    ...
    public class DensityPartitionBenchmarkRunner : MonoBehaviour
    {
        ...
        public string RunAllAndDump()
        {
            ...
            // Algorithm matrix.
            //   Row 0 - ProductionFixedGrid17 - the LITERAL shipped algorithm: 17^3
        ...
        public void EnsureDefaults()
        {
            ...
            // The Sec 2.3.1 staleness test - phantom Blue at the Jade-dominant
            ...
            bool massWeighted)
        {
            ...
            // why iteration 1's mass% sat at 44-52% even when Delta was small.
            float s = 0f;
