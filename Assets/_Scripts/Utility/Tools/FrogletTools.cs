...
namespace CosmicShore.Utility.Tools
{
    public class FrogletTools : Editor
    {
        ...
        private static void OpenMainScene()
        {
            ...
            Debug.LogFormat(
                "{0} - {1} - Opening Tail Glider Main Menu scene. - Please wait a second for the scene to load.",
                nameof(FrogletTools), nameof(OpenMainScene));
        }
        ...
        private static void OpenPhotoBooth()
        {
            ...
            Debug.LogFormat("{0} - {1} - Opening Tail Glider Photo Booth.", nameof(FrogletTools),
                nameof(OpenPhotoBooth));
        }
        ...
        private static void OpenRecordingStudio()
        {
            ...
            Debug.LogFormat("{0} - {1} - Opening Tail Glider Recording Studio.", nameof(FrogletTools),
                nameof(OpenRecordingStudio));
        }
        ...
        {
            // Open the Photo Booth in the Editor (do not enter Play Mode)
            EditorSceneManager.OpenScene($"Assets/_Scenes/TestScenes/Playfab Sandbox Test/Playfab Sandbox.unity",
                OpenSceneMode.Single);
            Debug.LogFormat("{0} - {1} - Opening PlayFab Test Sandbox.", nameof(FrogletTools),
                nameof(OpenPlayFabSandbox));
        }
    }
}
