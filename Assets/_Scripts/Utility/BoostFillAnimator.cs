...
public class BoostFillAnimator : MonoBehaviour
{
    ...
    public void AnimateFillTo(float targetFill, float duration, Ease ease = Ease.Linear,
    ...
    public void AnimateFillUp(float duration, float to = 1f, Ease ease = Ease.InOutSine,
        System.Action onComplete = null)
    {
