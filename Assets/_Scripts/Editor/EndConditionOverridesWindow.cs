    ...
    public class EndConditionOverridesWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                ...
                "  • Canopy Run: crystals a DOMAIN collects to win the Gibbon race; " +
                "auto-calc from track waypoints x laps.",
                MessageType.Info);
            ...
            int cr  = Mathf.Max(0, EditorGUILayout.IntField("Canopy Run - Crystal Count", _config.canopyRunCrystalCount));
            if (EditorGUI.EndChangeCheck())
                Persist("Edit End Game Conditions", () =>
                {
                    ...
                    _config.canopyRunCrystalCount = cr;
                });
            ...
            EditorGUILayout.LabelField("Canopy Run", cr > 0 ? cr.ToString() : "auto (track waypoints)");
            EditorGUI.indentLevel--;
        ...
        string DescribeBuildValues()
        {
            return "SkimRace: " + Fmt(_config.hexRaceCrystalCountBuild, "auto") + "\n" +
                   ...
                   "Canopy Run: " + Fmt(_config.canopyRunCrystalCountBuild, "auto");
