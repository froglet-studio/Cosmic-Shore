...
namespace CosmicShore.Editor
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string LOAD_BOOTSTRAP_SCENE_ON_PLAY = "Tools/Cosmic Shore/Play Mode/Load Bootstrap Scene on Play";
        private const string DO_NOT_LOAD_BOOTSTRAP_SCENE_ON_PLAY = "Tools/Cosmic Shore/Play Mode/Do not load Bootstrap Scene on Play";
        ...
        /// Tools > Cosmic Shore > Play Mode menu items). The Performance Benchmark tool flips this off
        /// to capture a chosen scene directly, then restores it on play-exit.
        /// </summary>
