...
for cls in ["EyeParams","PinnaParams","BeakParams","MandibleParams","NoseLeafParams","AntennaParams",
            "CrestParams","BlowholeParams","WhiskerParams","HairParams","FangParams","FeatureParams"]:
...
PARAM_GROUP_CLASS = {"Eye":"EyeParams","Pinna":"PinnaParams","Beak":"BeakParams","Mandible":"MandibleParams",
                     ...
                     "Blowhole":"BlowholeParams","Whisker":"WhiskerParams","Hair":"HairParams","Fang":"FangParams"}
 ...
 dict(Key="Felidae", DisplayName="Felidae", IsHuman=False,
      ...
      Traits=[
        trait("PointedEars", "Pinna", ["Ears"], "EarTop", signature=True, pitch=78.0, roll=-12.0,
              Pinna=dict(Height=0.17, Width=0.12, Pointed=1.0, CupDepth=0.40, RimThickness=0.12, Tragus=0.0, ForwardTiltDeg=0.0, OutwardRollDeg=0.0, Thickness=0.010)),
 ...
 dict(Key="Chiroptera", DisplayName="Chiroptera", IsHuman=False,
      ...
      Traits=[
        trait("GreatEars", "Pinna", ["Ears"], "EarTop", signature=True, pitch=72.0, roll=-8.0,
              Pinna=dict(Height=0.30, Width=0.15, Pointed=0.6, CupDepth=0.60, RimThickness=0.10, Tragus=1.0, ForwardTiltDeg=0.0, OutwardRollDeg=4.0, Thickness=0.008)),
