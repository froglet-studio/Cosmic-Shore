...
namespace CosmicShore.Core
{
    ...
    /// Deferred to the quest-system pass - see Docs/Analytics/DATA_ARCHITECTURE.md §3.4.
    /// </summary>
    [Serializable]
    public class GameModeProgressionData
    {
        ...
        /// <summary>
        /// Schema version. This model is otherwise unchanged pending the quest-system pass,
        /// but it carries a version now so that pass is a migration rather than another break.
        /// </summary>
