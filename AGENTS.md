...
| `SKIMRACE.md` | `_Scripts/Controller/Arcade/` | HexRace game mode technical reference |
...
| `PEEL_THE_CAGE.md` | `_Scripts/Controller/Arcade/` | Ribcage / "Peel the Cage" technical reference (Rhino-only cage-breaking race; the layered-orange intensity model, the open-weave generator, the shielded-mass targeting-grid rule, and the record of the removed fauna ladder) |
