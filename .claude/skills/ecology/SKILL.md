...
- `Docs/ECOSYSTEM_MASTERPLAN.md` - north star, the artificial-life scorecard (Sec 3), the **collider
  contract (Sec 4)**, the platform-wiring plan (Sec 5), the phased roadmap (Sec 6), the orchestration (Sec 7).
...
- **Config-driven:** tunables in ScriptableObjects; cross-system comms via SOAP events/variables;
  no singletons/static events. Variety = biome x intensity x heritable traits, not bespoke code.
